...
public class HttpAsyncClientUtil{
	...
	public static CloseableHttpAsyncClient create(String url) throws HttpProcessException{
		if(url.toLowerCase().startsWith("https://")){
			return MyHttpAsyncClientBuilder.custom().ssl().pool(800,300).build();
		}else{
			return MyHttpAsyncClientBuilder.custom().pool(800,300).build();
		}
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static void send(HttpAsyncConfig config) throws HttpProcessException {
		execute(config);
	}
	...
	public static void get(CloseableHttpAsyncClient client, String url, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.GET).asynclient(client).url(url).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void get(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void post(CloseableHttpAsyncClient client, String url, Map<String,Object> parasMap, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.POST).asynclient(client).url(url).map(parasMap).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void post(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void put(CloseableHttpAsyncClient client, String url, Map<String,Object>parasMap, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.PUT).asynclient(client).url(url).map(parasMap).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void put(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void delete(CloseableHttpAsyncClient client, String url, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.DELETE).asynclient(client).url(url).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void delete(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void patch(CloseableHttpAsyncClient client, String url, Map<String,Object>parasMap, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.PATCH).asynclient(client).url(url).map(parasMap).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void patch(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void head(CloseableHttpAsyncClient client, String url, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.HEAD).asynclient(client).url(url).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void head(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void options(CloseableHttpAsyncClient client, String url, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.OPTIONS).asynclient(client).url(url).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void options(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void trace(CloseableHttpAsyncClient client, String url, Header[] headers, HttpContext context, String encoding, IHandler handler) throws HttpProcessException {
		send(HttpAsyncConfig.custom().method(HttpMethods.TRACE).asynclient(client).url(url).headers(headers).context(context).encoding(encoding).handler(handler));
	}
	 ...
	 * @throws HttpProcessException 
	 */
	public static void trace(HttpAsyncConfig config) throws HttpProcessException {
	...
	public static void down(CloseableHttpAsyncClient client, String url, Header[] headers, HttpContext context, OutputStream out) throws HttpProcessException {
		execute(HttpAsyncConfig.custom().method(HttpMethods.GET).asynclient(client).url(url).headers(headers).context(context).out(out));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static void down(HttpAsyncConfig config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	private static void execute(HttpAsyncConfig config) throws HttpProcessException {
		...
		try {
			...
			if(HttpEntityEnclosingRequestBase.class.isAssignableFrom(request.getClass())){
				...
				//检测url中是否存在参数
				config.url(HttpAsyncUtils.checkHasParas(config.url(), nvps, config.inenc()));
				
				//装填参数
				HttpEntity entity = HttpAsyncUtils.map2List(nvps, config.map(), config.inenc());
	...
	public static void main(String[] args) throws HttpProcessException {
		...
		HttpAsyncClientUtil.send(HttpAsyncConfig.custom().url(url).handler(handler));
	}
}